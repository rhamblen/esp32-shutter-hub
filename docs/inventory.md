...
| ---- | ---- | ------ | ----- |
| ESP32-D DevKit | Hub controller | ⬤ (existing stock) | 16 LEDC channels; I2C on GPIO21/22 |
| PCA9685 | 16-ch servo driver | ⬤ | I2C 0x40; servos on CH0–3 |
| MG90D digital metal-gear servo ×4 | Tilt actuators | ⬤ | ~2 kg·cm, ~13–14 g, 4.8–6 V |
| VEML7700 | Ambient light sensor | ⬤ | I2C 0x10; 0–120,000 lux; solar protection |
